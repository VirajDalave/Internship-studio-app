...
<body>
    <div class="container">
        <div class="content">
            <h1Hello ... ! <span class="name">DevOps Enthusiast !</span></h1>
            <p>My name is <span class="highlighted-name">Viraj</span>, I am an <span class="trainer">AWS and DevOps Engineer</span>.</p>
